...
const appTranslations: Record<AppLanguage, any> = {
  en: {
    ...
    projects: {
      ...
      noMatchingProjects: 'No projects match your filters',
      createSuccess: 'Project created successfully',
      updateSuccess: 'Project updated successfully',
      deleteSuccess: 'Project deleted successfully',
      deleteConfirm: 'Are you sure you want to delete this project? This will also delete all tasks associated with it. This action cannot be undone.',
      tasks: 'Tasks',
      addTask: 'Add Task',
      editTask: 'Edit Task',
      ...
      noExpenses: 'No expenses linked to this project yet.',
    },
    dashboard: {
      title: 'Dashboard',
  ...
  de: {
    ...
    projects: {
      ...
      noMatchingProjects: 'Keine Projekte entsprechen Ihren Filtern',
      ...
      deleteConfirm: 'Sind Sie sicher, dass Sie dieses Projekt löschen möchten? Damit werden auch alle zugehörigen Aufgaben gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.',
      tasks: 'Aufgaben',
      ...
      noInvoices: 'Noch keine Rechnungen mit diesem Projekt verknüpft.',
      noExpenses: 'Noch keine Ausgaben mit diesem Projekt verknüpft.',
    },
    dashboard: {
      title: 'Dashboard',
  ...
  fr: {
    ...
    projects: {
      title: 'Projets',
      subtitle: 'Gérez vos projets et suivez les progrès',
      ...
      noProjects: 'Pas encore de projets. Créez votre premier projet !',
      noMatchingProjects: 'Aucun projet ne correspond à vos filtres',
      ...
      deleteConfirm: 'Êtes-vous sûr de vouloir supprimer ce projet ? Cela supprimera également toutes les tâches associées. Cette action ne peut pas être annulée.',
      tasks: 'Tâches',
      ...
      noTasks: 'Pas encore de tâches. Ajoutez votre première tâche !',
      taskCreated: 'Tâche créée avec succès',
      taskUpdated: 'Tâche mise à jour avec succès',
      taskDeleted: 'Tâche supprimée avec succès',
      deleteTaskConfirm: 'Êtes-vous sûr de vouloir supprimer cette tâche ? Cette action ne peut pas être annulée.',
      totalInvoiced: 'Total facturé',
      paid: 'Payé',
      totalExpenses: 'Total des dépenses',
      netProfit: 'Bénéfice net',
      noInvoices: 'Aucune facture liée à ce projet pour le moment.',
      noExpenses: 'Aucune dépense liée à ce projet pour le moment.',
    },
    dashboard: {
  ...
  vi: {
    ...
    projects: {
      ...
      noProjects: 'Chưa có dự án. Tạo dự án đầu tiên của bạn!',
      noMatchingProjects: 'Không có dự án nào phù hợp với bộ lọc',
      createSuccess: 'Tạo dự án thành công',
      updateSuccess: 'Cập nhật dự án thành công',
      deleteSuccess: 'Xóa dự án thành công',
      deleteConfirm: 'Bạn có chắc chắn muốn xóa dự án này? Điều này cũng sẽ xóa tất cả các nhiệm vụ liên quan. Hành động này không thể hoàn tác.',
      tasks: 'Nhiệm vụ',
      ...
      priority: 'Độ ưu tiên',
      dueDate: 'Hạn chót',
      noTasks: 'Chưa có nhiệm vụ. Thêm nhiệm vụ đầu tiên!',
      taskCreated: 'Tạo nhiệm vụ thành công',
      taskUpdated: 'Cập nhật nhiệm vụ thành công',
      taskDeleted: 'Xóa nhiệm vụ thành công',
      deleteTaskConfirm: 'Bạn có chắc chắn muốn xóa nhiệm vụ này? Hành động này không thể hoàn tác.',
      totalInvoiced: 'Tổng đã lập hóa đơn',
      paid: 'Đã thanh toán',
      totalExpenses: 'Tổng chi phí',
      netProfit: 'Lợi nhuận ròng',
      noInvoices: 'Chưa có hóa đơn liên kết với dự án này.',
      noExpenses: 'Chưa có chi phí liên kết với dự án này.',
    },
    dashboard: {
  ...
  ja: {
    ...
    projects: {
      ...
      completedProjects: '完了',
      totalBudget: '総予算',
      noProjects: 'プロジェクトがありません。最初のプロジェクトを作成してください！',
      noMatchingProjects: 'フィルターに一致するプロジェクトがありません',
      createSuccess: 'プロジェクトが正常に作成されました',
      updateSuccess: 'プロジェクトが正常に更新されました',
      deleteSuccess: 'プロジェクトが正常に削除されました',
      deleteConfirm: 'このプロジェクトを削除してもよろしいですか？関連するすべてのタスクも削除されます。この操作は取り消せません。',
      tasks: 'タスク',
      addTask: 'タスクを追加',
      editTask: 'タスクを編集',
      deleteTask: 'タスクを削除',
      ...
      priority: '優先度',
      dueDate: '期限',
      noTasks: 'タスクがありません。最初のタスクを追加してください！',
      taskCreated: 'タスクが正常に作成されました',
      taskUpdated: 'タスクが正常に更新されました',
      taskDeleted: 'タスクが正常に削除されました',
      deleteTaskConfirm: 'このタスクを削除してもよろしいですか？この操作は取り消せません。',
      totalInvoiced: '請求総額',
      paid: '支払済み',
      totalExpenses: '経費合計',
      netProfit: '純利益',
      noInvoices: 'このプロジェクトにリンクされた請求書はまだありません。',
      noExpenses: 'このプロジェクトにリンクされた経費はまだありません。',
    },
    dashboard: {
      title: 'ダッシュボード',
      welcome: 'お帰りなさい',
  ...
  zh: {
    ...
    projects: {
      ...
      priority: '优先级',
      dueDate: '截止日期',
      noTasks: '暂无任务。添加您的第一个任务！',
      taskCreated: '任务创建成功',
      taskUpdated: '任务更新成功',
      taskDeleted: '任务删除成功',
      deleteTaskConfirm: '您确定要删除此任务吗？此操作无法撤销。',
      totalInvoiced: '发票总额',
      paid: '已付款',
      totalExpenses: '费用总额',
      netProfit: '净利润',
      noInvoices: '此项目尚无关联发票。',
      noExpenses: '此项目尚无关联费用。',
    },
    dashboard: {
      title: '仪表板',
      welcome: '欢迎回来',
